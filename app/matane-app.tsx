        ...
        <main className="onboarding-shell">
          ...
          {(account || guestMode) && (
            <form className="onboarding-card" onSubmit={createProfile}>
              ...
              <label>{t("profile.reading")}<input name="reading" required placeholder={t("profile.readingPlaceholder")} autoCapitalize="words" /><small>{t("profile.readingHelp")}</small></label>
          ...
          <aside className="profile-drawer" onClick={(event) => event.stopPropagation()}>
            ...
            {settingsView === "profile" && (
              <form className="profile-editor" onSubmit={updateProfile}>
                ...
                <label>{t("profile.reading")}<input name="reading" required defaultValue={user.reading} placeholder={t("profile.readingPlaceholder")} autoCapitalize="words" /><small>{t("profile.readingHelp")}</small></label>
