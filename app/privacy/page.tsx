...
const englishSections = [
  ...
  ["6. Information about other people", "Enter another person’s information only when you have lawful authority or permission to record and process it. Do not enter sensitive information, secrets, unlawful surveillance data, or content that infringes privacy, publicity, copyright, or other rights. Do not publish or use AI output for identification or decisions about a person."],
...
const japaneseSections = [
  ...
  ["6. 第三者に関する情報", "他人の情報は、記録・処理する正当な権限または許可がある場合だけ入力してください。要配慮情報、秘密、違法な監視情報、肖像権・プライバシー・著作権等を侵害する内容は入力しないでください。AI出力を本人確認、公開、人物に影響する判断へ使わないでください。"],
