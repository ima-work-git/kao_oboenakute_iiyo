...
export const contacts = sqliteTable(
  "contacts",
  {
    ...
    exchangeLatitude: real("exchange_latitude"),
    exchangeLongitude: real("exchange_longitude"),
    exchangeAccuracy: real("exchange_accuracy"),
    ...
    portraitPreviousKey: text("portrait_previous_key").notNull().default(""),
    portraitPreviousFullBodyKey: text("portrait_previous_full_body_key").notNull().default(""),
    portraitPreviousMode: text("portrait_previous_mode").notNull().default(""),
    portraitPreviousUpdatedAt: text("portrait_previous_updated_at"),
